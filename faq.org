...
can read the license in all files and the full text in LICENSE file.

On an experimental way we are using a better license for women in the
dev branch. That's the copyright note: 

You can share, copy and modify this software if you are a woman or you
are David Arroyo Menéndez and you include this note.

We have stopped this policy in some Open Source event (for example,
Hacktoberfest) to speed up the development using only GPLv3. You will
love hackaton spirit.
