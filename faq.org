...
Some LGTB associations are claiming by non binary options about
gender, that is not an option for us due to there not states
acknowledging this need. The states are providing us the datasets.
