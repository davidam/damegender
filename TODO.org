...
* TODO Escribir api2gender.py dada una api y un nombre, extraer el género y la probabilidad si la da la api
  SCHEDULED: <2018-12-13 jue>
* TODO Reemplazar DameSexmachine heredando de Gender
  SCHEDULED: <2018-12-13 jue>
