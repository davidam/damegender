...
#    print(origwien)
    ...
    diccmales = du.dump_name_and_quantity_in_dicc(origwien, 7, 8, dicc=diccmales, delimiter=",",
    ...
    diccfemales = du.dump_name_and_quantity_in_dicc(origwien, 7, 8, dicc=diccfemales, delimiter=";",
                                                    filter_pos=5, filter_char='2')
#    print(diccfemales)
