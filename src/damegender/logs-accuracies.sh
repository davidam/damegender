...
echo "python3 accuracy.py --dataset_guess=files/names/allnoundefined.csv --dataset_test=files/names/allnoundefined.csv.adaboost.json --measure=accuracy --api=damegender --dataset_guess_row_gender=4 > files/logs/accuracy-adaboost-accuracy-"$(date "+%Y-%m-%d")".txt " > files/logs/accuracy-adaboost-accuracy-$(date "+%Y-%m-%d").txt

python3 accuracy.py --dataset_guess=files/names/allnoundefined.csv --dataset_test=files/names/allnoundefined.csv.adaboost.json --measure=accuracy --api=damegender --dataset_guess_row_gender=4 >> files/logs/accuracy-adaboost-accuracy-$(date "+%Y-%m-%d").txt

echo "python3 accuracy.py --dataset_guess=files/names/allnoundefined.csv --dataset_test=files/names/allnoundefined.csv.adaboost.json --measure=precision --api=damegender --dataset_guess_row_gender=4 > files/logs/accuracy-adaboost-precision-"$(date "+%Y-%m-%d")".txt " > files/logs/accuracy-adaboost-precision-$(date "+%Y-%m-%d").txt

python3 accuracy.py --dataset_guess=files/names/allnoundefined.csv --dataset_test=files/names/allnoundefined.csv.adaboost.json --measure=precision --api=damegender --dataset_guess_row_gender=4 >> files/logs/accuracy-adaboost-precision-$(date "+%Y-%m-%d").txt

echo "python3 accuracy.py --dataset_guess=files/names/allnoundefined.csv --dataset_test=files/names/allnoundefined.csv.adaboost.json --measure=recall --api=damegender --dataset_guess_row_gender=4 > files/logs/accuracy-adaboost-recall-"$(date "+%Y-%m-%d")".txt " > files/logs/accuracy-adaboost-recall-$(date "+%Y-%m-%d").txt

python3 accuracy.py --dataset_guess=files/names/allnoundefined.csv --dataset_test=files/names/allnoundefined.csv.adaboost.json --measure=recall --api=damegender --dataset_guess_row_gender=4 >> files/logs/accuracy-adaboost-recall-$(date "+%Y-%m-%d").txt
