...
understand that ``if you cannot measure it, you cannot improve
...
engineering~\cite{barry1981software}. So, the objective in this paper
is reduce costs to measure gender gap.
...
\section{Changing Software Industry with Open Datasets about Names, Gender and Frequency}
\label{sec:changing}

Currently, when you are doing searches with strings about personal
names (ex: Leticia) in search engines such as Google, these strings
are not being classified as personal names, one solution will be data
structured such as JSON-LD, microdata, microformats, rdfa ... Another
solution will be store in the servers the Open Data Collection about
names, gender and frequency and identify the context about the string
is a personal name, that's an easy problem in popular sites such as
wikipedia, academic websites, ...
