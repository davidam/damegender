...
From my point of view, the current state of art must be updated with
Open Data sources as base of truth, this work is helping to look 
for datasets check accuracies with several data sources in statistical
institutions and other Open Data trust sources very useful to check
statistical institutions as Wikipedia, Project Gutenberg, Amazon,
sport institutions, Forbes, ...
